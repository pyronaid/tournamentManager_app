...
class CustomFlowIconButton extends StatefulWidget {
  const CustomFlowIconButton({
    super.key,
    required this.icon,
    this.borderColor,
    this.borderRadius,
  ...
  @override
  State<CustomFlowIconButton> createState() => _FlutterFlowIconButtonState();
}

class _FlutterFlowIconButtonState extends State<CustomFlowIconButton> {
  bool loading = false;
  ...
  @override
  void didUpdateWidget(CustomFlowIconButton oldWidget) {
