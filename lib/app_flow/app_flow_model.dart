...
Widget wrapWithModel<T extends CustomFlowModel>({
  required T model,
...
T createModel<T extends CustomFlowModel>(
...
abstract class CustomFlowModel<W extends Widget> {
