...
class _RegisteredBody extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final model = context.read<TournamentRegisteredPeopleModel>();
...
// ---------------------------------------------------------------------------
// PEOPLE APP BAR
// Pinned SliverAppBar with search field, optional add button, and count badge.
// ---------------------------------------------------------------------------
class _PeopleAppBar extends StatelessWidget {
  const _PeopleAppBar({required this.model});

  final TournamentRegisteredPeopleModel model;
      ...
      flexibleSpace: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // ── Count badge — rebuilt only when countElements changes ────
            Selector<TournamentRegisteredPeopleModel, int>(
