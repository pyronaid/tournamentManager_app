...
class OwnTournamentsModel extends ChangeNotifier {
  ...
  StreamSubscription<QuerySnapshot>? _ownTournamentsSubscription;
  ...
  void dispose() {
    ...
    _ownTournamentsSubscription?.cancel();
    unfocusNode.dispose();
    super.dispose();
  }
  ...
  Future<void> fetchObjectUsingId() async {
    ...
    _ownTournamentsSubscription = TournamentsRecord.getDocumentsByOwner(currentUserUid).listen((querySnapshot) async {
